...
export async function run (client: ReknownClient, message: Message, args: string[]) {
    ...
    if(user.hasPermission('ADMINISTRATOR')) return await message.channel.send(new MessageEmbed().setDescription(`${error} You can't ban a Moderator.`))

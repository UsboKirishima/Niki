...
import { links } from '../../utils/Roleplay/kiss.json'
...
export async function run (client: ReknownClient, message: Message, args: string[]) {
    ...
    message.channel.send(new MessageEmbed().setImage(gg).setDescription(`**${user.user.username}** wants a kiss!`).setColor('RANDOM'))
} 

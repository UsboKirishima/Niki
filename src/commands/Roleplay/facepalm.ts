...
import { links } from '../../utils/Roleplay/facepalm.json'
...
export async function run (client: ReknownClient, message: Message, args: string[]) {
    ...
    message.channel.send(new MessageEmbed().setImage(gg).setDescription(`**${user.user.username}** is facepalming!`).setColor('RANDOM'))
} 

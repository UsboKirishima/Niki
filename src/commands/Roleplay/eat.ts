...
import { links } from '../../utils/Roleplay/eat.json'
...
export async function run (client: ReknownClient, message: Message, args: string[]) {
    ...
    message.channel.send(new MessageEmbed().setImage(gg).setDescription(`**${user.user.username}** is eating!`).setColor('RANDOM'))
} 

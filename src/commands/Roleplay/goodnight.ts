...
import { links } from '../../utils/Roleplay/goodnight.json'
...
export async function run (client: ReknownClient, message: Message, args: string[]) {
    ...
    message.channel.send(new MessageEmbed().setImage(gg).setDescription(`**${user.user.username}** wishes everyone a good night!`).setColor('RANDOM'))
} 

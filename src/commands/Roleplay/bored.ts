...
import { links } from '../../utils/Roleplay/bored.json'
...
export async function run (client: ReknownClient, message: Message, args: string[]) {
    ...
    message.channel.send(new MessageEmbed().setImage(gg).setDescription(`**${user.user.username}** is bored!`).setColor('RANDOM'))
} 

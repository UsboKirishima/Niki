...
const kill_json_1 = require("../../utils/Roleplay/kill.json");
async function run(client, message, args) {
    ...
    let gg = kill_json_1.links[mathRandom(kill_json_1.links.length)];
    message.channel.send(new discord_js_1.MessageEmbed().setImage(gg).setDescription(`**${user.user.username}** wants to be killed :(`).setColor('RANDOM'));
}
exports.run = run;
exports.help = {
    aliases: [''],

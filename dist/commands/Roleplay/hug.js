...
const hug_json_1 = require("../../utils/Roleplay/hug.json");
async function run(client, message, args) {
    ...
    let gg = hug_json_1.links[mathRandom(hug_json_1.links.length)];
    message.channel.send(new discord_js_1.MessageEmbed().setImage(gg).setDescription(`**${user.user.username}** wants a hug!`).setColor('RANDOM'));
}
exports.run = run;
exports.help = {
    aliases: [''],

...
const blush_json_1 = require("../../utils/Roleplay/blush.json");
async function run(client, message, args) {
    ...
    let gg = blush_json_1.links[mathRandom(blush_json_1.links.length)];
    message.channel.send(new discord_js_1.MessageEmbed().setImage(gg).setDescription(`**${user.user.username}** is blushing!`).setColor('RANDOM'));
}
exports.run = run;
exports.help = {
    aliases: [''],

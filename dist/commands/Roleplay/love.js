...
const love_json_1 = require("../../utils/Roleplay/love.json");
async function run(client, message, args) {
    ...
    let gg = love_json_1.links[mathRandom(love_json_1.links.length)];
    message.channel.send(new discord_js_1.MessageEmbed().setImage(gg).setDescription(`**${user.user.username}** wants to be loved! Aww ; - ;`).setColor('RANDOM'));
}
exports.run = run;
exports.help = {
    aliases: [''],

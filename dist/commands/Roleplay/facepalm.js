...
const facepalm_json_1 = require("../../utils/Roleplay/facepalm.json");
async function run(client, message, args) {
    ...
    let gg = facepalm_json_1.links[mathRandom(facepalm_json_1.links.length)];
    message.channel.send(new discord_js_1.MessageEmbed().setImage(gg).setDescription(`**${user.user.username}** is facepalming!`).setColor('RANDOM'));
}
exports.run = run;
exports.help = {
    aliases: [''],

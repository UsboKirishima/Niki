...
const boast_json_1 = require("../../utils/Roleplay/boast.json");
async function run(client, message, args) {
    ...
    let gg = boast_json_1.links[mathRandom(boast_json_1.links.length)];
    message.channel.send(new discord_js_1.MessageEmbed().setImage(gg).setDescription(`**${user.user.username}** is boasting!`).setColor('RANDOM'));
}
exports.run = run;
exports.help = {
    aliases: [''],

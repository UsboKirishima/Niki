...
const dead_json_1 = require("../../utils/Roleplay/dead.json");
async function run(client, message, args) {
    ...
    let gg = dead_json_1.links[mathRandom(dead_json_1.links.length)];
    message.channel.send(new discord_js_1.MessageEmbed().setImage(gg).setDescription(`**${user.user.username}** is dead`).setColor('RANDOM'));
}
exports.run = run;
exports.help = {
    aliases: [''],

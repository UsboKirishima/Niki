...
const bored_json_1 = require("../../utils/Roleplay/bored.json");
async function run(client, message, args) {
    ...
    let gg = bored_json_1.links[mathRandom(bored_json_1.links.length)];
    message.channel.send(new discord_js_1.MessageEmbed().setImage(gg).setDescription(`**${user.user.username}** is bored!`).setColor('RANDOM'));
}
exports.run = run;
exports.help = {
    aliases: [''],

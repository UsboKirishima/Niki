...
const goodnight_json_1 = require("../../utils/Roleplay/goodnight.json");
async function run(client, message, args) {
    ...
    let gg = goodnight_json_1.links[mathRandom(goodnight_json_1.links.length)];
    message.channel.send(new discord_js_1.MessageEmbed().setImage(gg).setDescription(`**${user.user.username}** wishes everyone a good night!`).setColor('RANDOM'));
}
exports.run = run;
exports.help = {
    aliases: [''],

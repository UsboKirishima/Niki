...
const highfive_json_1 = require("../../utils/Roleplay/highfive.json");
async function run(client, message, args) {
    ...
    let gg = highfive_json_1.links[mathRandom(highfive_json_1.links.length)];
    message.channel.send(new discord_js_1.MessageEmbed().setImage(gg).setDescription(`**${user.user.username}** wants a highfive!`).setColor('RANDOM'));
}
exports.run = run;
exports.help = {
    aliases: [''],

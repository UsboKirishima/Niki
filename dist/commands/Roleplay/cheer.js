...
const cheer_json_1 = require("../../utils/Roleplay/cheer.json");
async function run(client, message, args) {
    ...
    let gg = cheer_json_1.links[mathRandom(cheer_json_1.links.length)];
    message.channel.send(new discord_js_1.MessageEmbed().setImage(gg).setDescription(`**${user.user.username}** is cheering!`).setColor('RANDOM'));
}
exports.run = run;
exports.help = {
    aliases: [''],

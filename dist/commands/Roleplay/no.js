...
const no_json_1 = require("../../utils/Roleplay/no.json");
async function run(client, message, args) {
    ...
    let gg = no_json_1.links[mathRandom(no_json_1.links.length)];
    message.channel.send(new discord_js_1.MessageEmbed().setImage(gg).setDescription(`**${user.user.username}** says no!`).setColor('RANDOM'));
}
exports.run = run;
exports.help = {
    aliases: [''],

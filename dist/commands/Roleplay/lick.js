...
const lick_json_1 = require("../../utils/Roleplay/lick.json");
async function run(client, message, args) {
    ...
    let gg = lick_json_1.links[mathRandom(lick_json_1.links.length)];
    message.channel.send(new discord_js_1.MessageEmbed().setImage(gg).setDescription(`**${user.user.username}** wants to be licked!`).setColor('RANDOM'));
}
exports.run = run;
exports.help = {
    aliases: [''],

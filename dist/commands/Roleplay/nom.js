...
const nom_json_1 = require("../../utils/Roleplay/nom.json");
async function run(client, message, args) {
    ...
    let gg = nom_json_1.links[mathRandom(nom_json_1.links.length)];
    message.channel.send(new discord_js_1.MessageEmbed().setImage(gg).setDescription(`**${user.user.username}** wants to be nommed!`).setColor('RANDOM'));
}
exports.run = run;
exports.help = {
    aliases: [''],

...
const bye_json_1 = require("../../utils/Roleplay/bye.json");
async function run(client, message, args) {
    ...
    let gg = bye_json_1.links[mathRandom(bye_json_1.links.length)];
    message.channel.send(new discord_js_1.MessageEmbed().setImage(gg).setDescription(`**${user.user.username}** is saying goodbye!`).setColor('RANDOM'));
}
exports.run = run;
exports.help = {
    aliases: [''],

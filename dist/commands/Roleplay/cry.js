...
const cry_json_1 = require("../../utils/Roleplay/cry.json");
async function run(client, message, args) {
    ...
    let gg = cry_json_1.links[mathRandom(cry_json_1.links.length)];
    message.channel.send(new discord_js_1.MessageEmbed().setImage(gg).setDescription(`**${user.user.username}** is crying!`).setColor('RANDOM'));
}
exports.run = run;
exports.help = {
    aliases: [''],

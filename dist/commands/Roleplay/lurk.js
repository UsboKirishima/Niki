...
const lurk_json_1 = require("../../utils/Roleplay/lurk.json");
async function run(client, message, args) {
    ...
    let gg = lurk_json_1.links[mathRandom(lurk_json_1.links.length)];
    message.channel.send(new discord_js_1.MessageEmbed().setImage(gg).setDescription(`**${user.user.username}** is lurking!`).setColor('RANDOM'));
}
exports.run = run;
exports.help = {
    aliases: [''],

...
const mad_json_1 = require("../../utils/Roleplay/mad.json");
async function run(client, message, args) {
    ...
    let gg = mad_json_1.links[mathRandom(mad_json_1.links.length)];
    message.channel.send(new discord_js_1.MessageEmbed().setImage(gg).setDescription(`**${user.user.username}** is mad!`).setColor('RANDOM'));
}
exports.run = run;
exports.help = {
    aliases: [''],

...
const dance_json_1 = require("../../utils/Roleplay/dance.json");
async function run(client, message, args) {
    ...
    let gg = dance_json_1.links[mathRandom(dance_json_1.links.length)];
    message.channel.send(new discord_js_1.MessageEmbed().setImage(gg).setDescription(`**${user.user.username}** is dancing!`).setColor('RANDOM'));
}
exports.run = run;
exports.help = {
    aliases: [''],

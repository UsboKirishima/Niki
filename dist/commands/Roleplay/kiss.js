...
const kiss_json_1 = require("../../utils/Roleplay/kiss.json");
async function run(client, message, args) {
    ...
    let gg = kiss_json_1.links[mathRandom(kiss_json_1.links.length)];
    message.channel.send(new discord_js_1.MessageEmbed().setImage(gg).setDescription(`**${user.user.username}** wants a kiss!`).setColor('RANDOM'));
}
exports.run = run;
exports.help = {
    aliases: [''],

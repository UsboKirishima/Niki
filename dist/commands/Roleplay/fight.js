...
const fight_json_1 = require("../../utils/Roleplay/fight.json");
async function run(client, message, args) {
    ...
    let gg = fight_json_1.links[mathRandom(fight_json_1.links.length)];
    message.channel.send(new discord_js_1.MessageEmbed().setImage(gg).setDescription(`**${user.user.username}** wants to fight someone!`).setColor('RANDOM'));
}
exports.run = run;
exports.help = {
    aliases: [''],

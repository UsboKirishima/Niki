...
const feed_json_1 = require("../../utils/Roleplay/feed.json");
async function run(client, message, args) {
    ...
    let gg = feed_json_1.links[mathRandom(feed_json_1.links.length)];
    message.channel.send(new discord_js_1.MessageEmbed().setImage(gg).setDescription(`**${user.user.username}** wants to be fed!`).setColor('RANDOM'));
}
exports.run = run;
exports.help = {
    aliases: [''],

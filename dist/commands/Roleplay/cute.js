...
const cute_json_1 = require("../../utils/Roleplay/cute.json");
async function run(client, message, args) {
    ...
    let gg = cute_json_1.links[mathRandom(cute_json_1.links.length)];
    message.channel.send(new discord_js_1.MessageEmbed().setImage(gg).setDescription(`**${user.user.username}** is being cute!`).setColor('RANDOM'));
}
exports.run = run;
exports.help = {
    aliases: [''],

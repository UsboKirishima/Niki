...
const nope_json_1 = require("../../utils/Roleplay/nope.json");
async function run(client, message, args) {
    ...
    let gg = nope_json_1.links[mathRandom(nope_json_1.links.length)];
    message.channel.send(new discord_js_1.MessageEmbed().setImage(gg).setDescription(`**${user.user.username}** is saying "nope, just nope!`).setColor('RANDOM'));
}
exports.run = run;
exports.help = {
    aliases: [''],

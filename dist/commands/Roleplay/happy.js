...
const happy_json_1 = require("../../utils/Roleplay/happy.json");
async function run(client, message, args) {
    ...
    let gg = happy_json_1.links[mathRandom(happy_json_1.links.length)];
    message.channel.send(new discord_js_1.MessageEmbed().setImage(gg).setDescription(`**${user.user.username}** is happy!`).setColor('RANDOM'));
}
exports.run = run;
exports.help = {
    aliases: [''],

...
const bonk_json_1 = require("../../utils/Roleplay/bonk.json");
async function run(client, message, args) {
    ...
    let gg = bonk_json_1.links[mathRandom(bonk_json_1.links.length)];
    message.channel.send(new discord_js_1.MessageEmbed().setImage(gg).setDescription(`**${user.user.username}** wants to be bonked`).setColor('RANDOM'));
}
exports.run = run;
exports.help = {
    aliases: [''],

...
const dab_json_1 = require("../../utils/Roleplay/dab.json");
async function run(client, message, args) {
    ...
    let gg = dab_json_1.links[mathRandom(dab_json_1.links.length)];
    message.channel.send(new discord_js_1.MessageEmbed().setImage(gg).setDescription(`**${user.user.username}** is dabbing!`).setColor('RANDOM'));
}
exports.run = run;
exports.help = {
    aliases: [''],

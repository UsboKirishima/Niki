...
const hate_json_1 = require("../../utils/Roleplay/hate.json");
async function run(client, message, args) {
    ...
    let gg = hate_json_1.links[mathRandom(hate_json_1.links.length)];
    message.channel.send(new discord_js_1.MessageEmbed().setImage(gg).setDescription(`**${user.user.username}** hates another user!`).setColor('RANDOM'));
}
exports.run = run;
exports.help = {
    aliases: [''],

...
const confused_json_1 = require("../../utils/Roleplay/confused.json");
async function run(client, message, args) {
    ...
    let gg = confused_json_1.links[mathRandom(confused_json_1.links.length)];
    message.channel.send(new discord_js_1.MessageEmbed().setImage(gg).setDescription(`**${user.user.username}** is confused!`).setColor('RANDOM'));
}
exports.run = run;
exports.help = {
    aliases: [''],

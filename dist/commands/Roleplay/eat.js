...
const eat_json_1 = require("../../utils/Roleplay/eat.json");
async function run(client, message, args) {
    ...
    let gg = eat_json_1.links[mathRandom(eat_json_1.links.length)];
    message.channel.send(new discord_js_1.MessageEmbed().setImage(gg).setDescription(`**${user.user.username}** is eating!`).setColor('RANDOM'));
}
exports.run = run;
exports.help = {
    aliases: [''],

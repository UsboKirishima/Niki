...
const grumpy_json_1 = require("../../utils/Roleplay/grumpy.json");
async function run(client, message, args) {
    ...
    let gg = grumpy_json_1.links[mathRandom(grumpy_json_1.links.length)];
    message.channel.send(new discord_js_1.MessageEmbed().setImage(gg).setDescription(`**${user.user.username}** is grumpy!`).setColor('RANDOM'));
}
exports.run = run;
exports.help = {
    aliases: [''],

...
const laugh_json_1 = require("../../utils/Roleplay/laugh.json");
async function run(client, message, args) {
    ...
    let gg = laugh_json_1.links[mathRandom(laugh_json_1.links.length)];
    message.channel.send(new discord_js_1.MessageEmbed().setImage(gg).setDescription(`**${user.user.username}** is laughing!`).setColor('RANDOM'));
}
exports.run = run;
exports.help = {
    aliases: [''],

...
const lewd_json_1 = require("../../utils/Roleplay/lewd.json");
async function run(client, message, args) {
    ...
    let gg = lewd_json_1.links[mathRandom(lewd_json_1.links.length)];
    message.channel.send(new discord_js_1.MessageEmbed().setImage(gg).setDescription(`**${user.user.username}** is being lewd!`).setColor('RANDOM'));
}
exports.run = run;
exports.help = {
    aliases: [''],

...
const fear_json_1 = require("../../utils/Roleplay/fear.json");
async function run(client, message, args) {
    ...
    let gg = fear_json_1.links[mathRandom(fear_json_1.links.length)];
    message.channel.send(new discord_js_1.MessageEmbed().setImage(gg).setDescription(`**${user.user.username}** wants to be afraid of someone!`).setColor('RANDOM'));
}
exports.run = run;
exports.help = {
    aliases: [''],

...
const baka_json_1 = require("../../utils/Roleplay/baka.json");
async function run(client, message, args) {
    ...
    let gg = baka_json_1.links[mathRandom(baka_json_1.links.length)];
    message.channel.send(new discord_js_1.MessageEmbed().setImage(gg).setDescription(`**${user.user.username}** wants to be called a baka`).setColor('RANDOM'));
}
exports.run = run;
exports.help = {
    aliases: [''],

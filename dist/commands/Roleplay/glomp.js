...
const glomp_json_1 = require("../../utils/Roleplay/glomp.json");
async function run(client, message, args) {
    ...
    let gg = glomp_json_1.links[mathRandom(glomp_json_1.links.length)];
    message.channel.send(new discord_js_1.MessageEmbed().setImage(gg).setDescription(`**${user.user.username}** wants to be glomped!`).setColor('RANDOM'));
}
exports.run = run;
exports.help = {
    aliases: [''],

...
const bite_json_1 = require("../../utils/Roleplay/bite.json");
async function run(client, message, args) {
    ...
    let gg = bite_json_1.links[mathRandom(bite_json_1.links.length)];
    message.channel.send(new discord_js_1.MessageEmbed().setImage(gg).setDescription(`**${user.user.username}** wants to be bitten`).setColor('RANDOM'));
}
exports.run = run;
exports.help = {
    aliases: [''],

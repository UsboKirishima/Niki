...
const goodmorning_json_1 = require("../../utils/Roleplay/goodmorning.json");
async function run(client, message, args) {
    ...
    let gg = goodmorning_json_1.links[mathRandom(goodmorning_json_1.links.length)];
    message.channel.send(new discord_js_1.MessageEmbed().setImage(gg).setDescription(`**${user.user.username}** wishes everyone a good morning!`).setColor('RANDOM'));
}
exports.run = run;
exports.help = {
    aliases: [''],

...
const hello_json_1 = require("../../utils/Roleplay/hello.json");
async function run(client, message, args) {
    ...
    let gg = hello_json_1.links[mathRandom(hello_json_1.links.length)];
    message.channel.send(new discord_js_1.MessageEmbed().setImage(gg).setDescription(`**${user.user.username}** is saying hello!`).setColor('RANDOM'));
}
exports.run = run;
exports.help = {
    aliases: [''],
